export function FormationsPageHeader() {
  return (
    <header className="max-w-2xl">
      ...
      <p className="mt-4 text-[15px] leading-relaxed text-[var(--kba-muted)] sm:text-base">
        Des parcours pratiques en prothésie ongulaire et extensions de cils,
        pensés pour vous permettre de vous lancer rapidement avec une méthode
        claire et un accompagnement de proximité.
      </p>
    </header>
  );
}
