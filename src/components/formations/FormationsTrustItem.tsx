...
export function FormationsTrustItem({ label, icon }: FormationsTrustItemProps) {
  return (
    <li className="flex min-w-[140px] flex-1 items-center gap-2.5 sm:min-w-0">
      <span className="flex h-9 w-9 shrink-0 items-center justify-center rounded-full bg-[var(--kba-primary)]/12 text-[var(--kba-primary)]">
        <TrustIcon name={icon} />
      </span>
